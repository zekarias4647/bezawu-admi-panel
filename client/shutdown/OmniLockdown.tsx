...
import { Orbit, CloudOff, Radio, Database, ShieldCheck, Cpu } from 'lucide-react';

interface OmniLockdownProps {
  onRestore?: () => void;
}

const OmniLockdown: React.FC<OmniLockdownProps> = ({ onRestore }) => {
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-6 overflow-hidden transition-all duration-1000 bg-[#02040a] selection:bg-cyan-500/30">
      ...
      <div className="relative z-10 max-w-3xl w-full text-center space-y-16">
        ...
        <div className="space-y-6">
          <h1 className="text-9xl font-black tracking-tighter leading-none italic text-transparent bg-clip-text bg-gradient-to-b from-white to-cyan-800 uppercase">BEZAW</h1>
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mt-2">Synchronization: SUSPENDED</p>
          </div>
        </div>
      ...
      <div className="absolute top-12 right-12 text-right">
        ...
        <p className="text-xl font-mono font-black text-white">42/42 <span className="text-[10px] text-cyan-400">BRANCHES</span></p>
      </div>
