        ...
        <div className="fixed inset-0 z-[100000] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-300">
          <div className={`max-w-xl w-full rounded-3xl overflow-hidden shadow-2xl transition-all border animate-in zoom-in-95 duration-200 ${isDarkMode ? 'bg-[#121418] border-slate-700' : 'bg-white border-slate-100'
            ...
            <div className="p-8 relative overflow-hidden">
              ...
              <button onClick={() => setShowBriefing(false)} className="absolute top-6 right-6 text-slate-400 hover:text-slate-900 transition-colors">
                <X size={20} />
              </button>
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className={`text-xl font-bold tracking-tight ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>AI Strategy Briefing</h2>
                  <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-0.5">Protocol Branch v4.0.2</p>
                </div>
              </div>
              ...
              <div className="space-y-6 relative z-10">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[8px] font-bold text-emerald-600 uppercase tracking-[0.3em]">EXECUTIVE SUMMARY</span>
                    <div className="h-px flex-1 bg-slate-800/10" />
                  </div>
